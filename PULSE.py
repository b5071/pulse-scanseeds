...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1bZfrPhsky3h3SeHjUHj71mqdspZfomPv", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1vscDi4yMuFUhAvL5sUjpWxGNbWQNQqxa", cache_dir=cache_dir, verbose=verbose) as f:
